...
public class BlockSethBlingOre extends Block
{
    private boolean field_150187_a;
    private static final String __OBFID = "CL_00000294";

    public BlockSethBlingOre(boolean p_i45420_1_)
    {
        super(Material.rock);
    ...
    private void func_150185_e(World p_150185_1_, int p_150185_2_, int p_150185_3_, int p_150185_4_)
    {
        ...
        if (this == BlockLoader.BlockSethBlingOre)
        {
            p_150185_1_.setBlock(p_150185_2_, p_150185_3_, p_150185_4_, BlockLoader.BlockSethBlingOre /*Blocks.lit_redstone_ore*/);
        }
    }
    ...
    {
        if (this == BlockLoader.BlockSethBlingOre /*BlockLoader.BlockSethBlingOre /*Blocks.lit_redstone_ore*/)
        {
            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, BlockLoader.BlockSethBlingOre);
        }
    }
    		/*
    ...
    {
        return new ItemStack(BlockLoader.BlockSethBlingOre);
    }
}