...
import com.jtrent238.youtubers.CustomEntityList;
...
public class ItemSpawnEgg extends Item
{
    ...
    public Entity spawnCreature(World world, int entityID, double x, double y, double z) {
        Entity entity = null;
        // the next few lines use CustomEntityList instead of the vanilla EntityList, everything else is almost identical
