...
public class EntityDiamondMinecartTNT extends EntityDiamondMinecart
{
    private int minecartTNTFuse = -1;
    private static final String __OBFID = "CL_00001680";

    public EntityDiamondMinecartTNT(World p_i1727_1_)
    {
        super(p_i1727_1_);
    }

    public EntityDiamondMinecartTNT(World p_i1728_1_, double p_i1728_2_, double p_i1728_4_, double p_i1728_6_)
    {
