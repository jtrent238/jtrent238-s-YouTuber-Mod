...
public class EntityskythekidRS extends EntityGolem implements IBossDisplayData
	{
		World world = null;
		private int attackTimer;
		private DamageSource damageSource;
		private EntityPlayer entityAttackedBy;
	    public EntityskythekidRS(World var1)
	    {
	        super(var1);
	        world = var1;
	        experienceValue = 10;
	        ...
	        this.setCustomNameTag("skythekidRS");
	        addRandomArmor();
	        //DungeonHooks.addDungeonMob("skythekidRS", 180);
	    }
