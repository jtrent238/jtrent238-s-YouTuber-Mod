...
public class EntityHeyItsLuigi extends EntityGolem implements IBossDisplayData
	{
		World world = null;
		private int attackTimer;
		private DamageSource damageSource;
		private EntityPlayer entityAttackedBy;
	    public EntityHeyItsLuigi(World var1)
	    {
	        super(var1);
	        world = var1;
	        experienceValue = 10;
	        ...
	        this.setCustomNameTag("HeyItsLuigi");
	        addRandomArmor();
	        //DungeonHooks.addDungeonMob("HeyItsLuigi", 180);
	    }
